...
const productPages = [
  { slug: "flow-measurement", title: "Flow Measurement", description: "Magnetic, ultrasonic, vortex, thermal mass, DP, and process measurement solutions for oil & gas and industrial applications.", subject: "Flow Measurement Application" },
  { slug: "pressure-instrumentation", title: "Pressure Instrumentation", description: "Transmitters, gauges, switches, diaphragm seals, and field-ready pressure solutions.", subject: "Pressure Instrumentation Application" },
  { slug: "level-measurement", title: "Level Measurement", description: "Radar, ultrasonic, guided wave radar, interface, and point level technologies.", subject: "Level Measurement Application" },
  { slug: "temperature", title: "Temperature", description: "RTDs, thermocouples, thermowells, transmitters, and custom temperature assemblies.", subject: "Temperature Application" },
  { slug: "control-valves", title: "Control Valves", description: "Control valves, actuators, automated packages, and severe-service valve solutions.", subject: "Control Valve Application" },
  { slug: "process-control", title: "Process Control", description: "Automation hardware, analyzers, panels, PLC/DCS integration, and process support.", subject: "Process Control Application" },
];
...
const manufacturers = [
  { name: "Rosemount", logo: "/manufacturers/rosemount.png", url: "https://www.emerson.com/en/measurement-instrumentation/rosemount" },
  { name: "Hobre", logo: "/manufacturers/hobre.png", url: "https://hobre.com/" },
  { name: "Teledyne Gas and Flame Detection", logo: "/manufacturers/teledyne.png", url: "https://www.teledynegasandflamedetection.com/en-us" },
  { name: "TASI Measurement", logo: "/manufacturers/tasi.png", url: "https://tasimeasurement.com/" },
];
      ...
      <header className="relative z-10 border-b border-slate-200 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-4">
            <img src="/k360-logo.png" alt="K360 Automation" className="h-20 w-auto" />
            <div>
          ...
          <div className="hidden items-center gap-5 md:flex">
            ...
            <a href="mailto:sales@k360automation.com" className="rounded-sm bg-orange-600 px-5 py-3 font-semibold text-white hover:bg-orange-700">
              Contact Sales
            </a>
          </div>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <a href="mailto:sales@k360automation.com" className="rounded-sm bg-orange-600 px-7 py-4 text-center font-semibold text-white hover:bg-orange-700">
                Talk Through an Application
              </a>
              <a href="#solutions" className="rounded-sm border border-slate-300 bg-white px-7 py-4 text-center font-semibold text-slate-900 hover:bg-slate-50">
                View Product Areas
              </a>
            </div>
          </div>
      ...
      <section id="solutions" className="relative z-10 mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {productPages.map(({ slug, title, description, subject }) => (
            <div key={slug} className="rounded-sm border border-slate-200 bg-white/95 p-7 shadow-sm backdrop-blur">
              <h3 className="text-lg font-bold">{title}</h3>
              <p className="mt-3 text-slate-600">{description}</p>
              <div className="mt-6 flex flex-col gap-3">
                <Link href={`/products/${slug}`} className="rounded-sm bg-orange-600 px-5 py-3 text-center font-semibold text-white hover:bg-orange-700">
                  Learn More
                </Link>
                <a
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 py-20">
        <div className="rounded-sm border border-orange-200 bg-orange-50/95 p-8 shadow-lg md:p-12">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            ...
            <a href="tel:+14050000000" className="rounded-sm border border-orange-400 bg-white px-7 py-4 text-center font-semibold text-orange-600 hover:bg-orange-50">
              405-000-0000
            </a>
          </div>
        </div>
